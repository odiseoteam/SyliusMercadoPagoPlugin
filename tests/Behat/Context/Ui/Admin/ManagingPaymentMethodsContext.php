...
namespace Tests\Odiseo\SyliusMercadoPagoPlugin\Behat\Context\Ui\Admin;
...
use Tests\Odiseo\SyliusMercadoPagoPlugin\Behat\Page\Admin\PaymentMethod\CreatePageInterface;
...
final class ManagingPaymentMethodsContext implements Context
{
    ...
    {
        $this->createPage->setMercadoPagoAccessToken('TEST');
    }
}
